...
def main():
    ...
    # =========================
    metrics = model.val(
        data=data_yaml, imgsz=640, batch=16, workers=4, save_json=True, project="runs/detect", name="cbam"
    )
    ...
    # 7 保存指标到txt
    # =========================
    save_path = Path("runs/detect/cbam")
    result_file = save_path / "cbam_metrics.txt"

    with open(result_file, "w") as f:
        f.write("cbam Results\n")
